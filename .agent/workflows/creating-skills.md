---
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use when the user wants to create a new skill or capability for the agent.
---

# Antigravity Skill Creator System Instructions

## When to use this skill
- When the user asks to "create a skill", "teach you a new capability", or "add a new tool".
- When you identify a repeatable complex task that would benefit from being a standardized skill.

## Workflow
- [ ] **Analyze Requirement**: Identify the trigger, the input, and the desired outcome.
- [ ] **Draft Structure**: Define the name (gerund), description (3rd person), and folder structure.
- [ ] **Write Instructions**: Draft the `SKILL.md` following the "Claude Way" principles (concise, progressive disclosure).
- [ ] **Verify**: Ensure YAML frontmatter is correct and strict format is followed.
- [ ] **Output**: Present the final skill folder structure and content to the user.
